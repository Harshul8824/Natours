      ...
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          ...
          if (res.data.status == 'success') {
            (0, _alerts.showAlerts)('success', 'loggedIn successfully');
            setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          (0, _alerts.showAlerts)('error', _t.response.data.message);
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          (0, _alerts.showAlerts)('error', 'Error logged Out! try again');
        case 3:
...
var dispplayMap = exports.dispplayMap = function dispplayMap(locations) {
  // Create map
  var map = L.map('map', {
    zoomControl: true,
    scrollWheelZoom: false,
    // Changed to false since you want interactive: false
    dragging: true,
    // Disable dragging
    touchZoom: false,
    // Disable touch zoom
  ...
  locations.forEach(function (loc) {
    ...
    L.marker(coords).addTo(map).bindPopup("<h1>".concat(loc.description, "</h1>"), {
      direction: 'top'
    });
    bounds.push(coords);
  });
...
var updateSttings = exports.updateSttings = /*#__PURE__*/function () {
  ...
  return function updateSttings(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"razorpay.js":[function(require,module,exports) {
"use strict";
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var loaded, res, order, options, rzp, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
        ...
        case 1:
          ...
          return _context.a(2, (0, _alerts.showAlert)('error', 'Razorpay SDK failed to load'));
        case 2:
          _context.n = 3;
          return (0, _axios.default)("/api/v1/bookings/razorpay-order/".concat(tourId));
        case 3:
          res = _context.v;
          order = res.data.order; // 3) Configure Razorpay checkout
          options = {
            key: undefined || 'rzp_test_xxxxxxxx',
            // test key
            amount: order.amount,
            ...
            handler: function handler() {
              (0, _alerts.showAlert)('success', 'Payment successful! Booking will be confirmed shortly.');
            },
            theme: {
              color: '#55c57a'
            }
...
if (mapBox) {
  ...
  (0, _leafletMap.dispplayMap)(locations);
}
if (loginForm) {
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    console.log(form);
    (0, _updateSettings.updateSttings)(form, 'data');
  });
}
if (userPasswordForm) {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            _context.n = 1;
            return (0, _updateSettings.updateSttings)({
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "17206" + '/');
